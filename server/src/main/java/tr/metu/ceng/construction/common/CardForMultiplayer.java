...
public class CardForMultiplayer implements Serializable {
    ...
    public boolean equals(Object otherObject) {
        ...
        if (!(otherObject instanceof CardForMultiplayer)) return false;
        CardForMultiplayer card = (CardForMultiplayer) otherObject;
     ...
     */
    public boolean compareRank(CardForMultiplayer otherCard) {
     ...
     */
    public boolean canCapture(CardForMultiplayer otherCard) {
